...
Si vous avez envoyé la \hero{Princesse}, rendez-vous au \glink{123}.
...
Si vous n'êtes dans aucun de ces cas particuliers, rendez-vous au \glink{118}.
...
Sinon, rendez-vous au \glink{118}.
...
Si vous désirez accepter cette proposition à l'aveuglette, estimant que le jeu en vaut la chandelle, rendez-vous au \glink{134}.
...
Si vous êtes dans un des cas suivants, rendez-vous au \glink{138} :
...
Sinon, rendez-vous au \glink{139}.
...
Rendez-vous au \glink{62} si le \hero{Métamorphe} porte le Coffret des Malheurs et au \glink{140} s'il tient plutôt la Branche de l'Arbre-Vie.
...
Sinon, rendez-vous au \glink{146}.
