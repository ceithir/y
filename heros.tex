...
Comme première embauche, mais avec une augmentation incrémentale de une pièce supplémentaire à chaque nouvelle embauche (6/16 à la seconde, 7/17 à la troisième etc.)
}{images/rogue.jpg}
...
Le Fétiche en Os ou tout objet inestimable ([-])
}{images/witch.jpg}
...
Elle est à la recherche de défis dans cette région désolée, c'est-à-dire de redoutables créatures de chair et de sang auxquelles elle puisse se mesurer en combat singulier. À défaut d'un bon combat violent entre deux êtres vivants poussés dans leurs derniers retranchements, elle se satisfera d'un trophée animal d'une grande rareté.
}{
Combat
}{
...
\hero{
Pour une fois, celui que vous désirez convertir à votre cause est une vieille connaissance. Vous avez étudié la magie ensemble voilà bien longtemps, avant que vos chemins ne divergent. En effet, alors que vous vous êtes toujours efforcé d'utiliser vos pouvoirs pour le bien, votre confrère avait une vision plus libérale des choses.

Il n'est pas mauvais en soi, mais il n'est pas bon non plus. Il marche plutôt dans une voie de neutralité et d'indépendance. Par exemple, sa spécialité est la nécromancie, mais il s'en sert comme une méthode pratique pour produire des sous-fifres pour ses expériences plutôt que pour tenter de dominer le monde.

Et heureusement pour vous, car il a beau ressembler à un personnage de conte de fée avec sa barbe impressionnante et sa bedaine enjouée, vous savez que derrière les sourires de façade se cache un impitoyable et terrible archimage.
}{
Recherche et Combat
}{
Gratuit pour toute Quête \ankh / Le Crâne du Vampire, le Tome Scellé ou l'Orbe Transiente pour toute autre Quête
}{
Le Crâne du Vampire, le Tome Scellé ou l'Orbe Transiente
}{images/necromancian.jpg}
...
\fullbleed{images/legendary.jpg}
...
Le reste du document (texte) est sous la même licence CC-BY-SA 3.0 que l'aventure elle-même. Voir celle-ci pour plus d'informations.
